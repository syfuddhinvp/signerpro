...
export default function FallbackArt({ tone = 'error' }: { tone?: 'error' | 'missing' }) {
  const accent = tone === 'error' ? '#f59e0b' : '#4f46e5';
  return (
    <svg
      viewBox="0 0 420 340"
      fill="none"
    ...
    >
      ...
      <circle cx="228" cy="160" r="132" fill="#4f46e5" opacity=".08" />
      <ellipse cx="210" cy="298" rx="132" ry="14" fill="#0f172a" opacity=".05" />

      {/* loose sheets scattered on the ground */}
      <g opacity=".55">
        <rect
          x="24" y="248" width="72" height="52" rx="6"
          fill="#fff" stroke="#cbd2de" strokeWidth="2.5" transform="rotate(-16 60 274)"
        />
        <rect
          x="322" y="252" width="72" height="52" rx="6"
          fill="#fff" stroke="#cbd2de" strokeWidth="2.5" transform="rotate(13 358 278)"
        />
      </g>
      ...
      <rect
        ...
        fill="#fff" stroke="#e3e7ee" strokeWidth="3" transform="rotate(8 271 152)"
      />
      ...
      <g transform="rotate(-6 186 152)">
        <path
          ...
          fill="#fff" stroke="#cbd2de" strokeWidth="3"
        />
        {/* folded corner */}
        <path d="M208 56v30a14 14 0 0 0 14 14h30L208 56Z" fill="#eef1f6" stroke="#cbd2de" strokeWidth="3" />

        {/* body copy lines */}
        <rect x="134" y="128" width="80" height="8" rx="4" fill="#e3e7ee" />
        <rect x="134" y="150" width="100" height="8" rx="4" fill="#e3e7ee" />
        <rect x="134" y="172" width="60" height="8" rx="4" fill="#e3e7ee" />
        ...
        />
        <rect x="134" y="232" width="92" height="3" rx="1.5" fill="#e3e7ee" />
      </g>

      {/* the tear: a jagged split straight across the sheet */}
      <path
        d="M96 190l26-11 14 13 23-14 18 14 25-16 21 15 27-13"
        stroke="#f5f6f8" strokeWidth="13" strokeLinecap="round" strokeLinejoin="round"
      />
      <path
        d="M96 190l26-11 14 13 23-14 18 14 25-16 21 15 27-13"
        stroke="#cbd2de" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
        strokeDasharray="12 10"
      />

      {/* status badge */}
      <circle cx="300" cy="212" r="46" fill="#fff" />
