  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#eceff4', fontFamily: SF_FONT, color: '#0f172a' }}>
      <header style={{ flex: '0 0 auto', background: '#fff', borderBottom: '1px solid #e3e7ee', padding: '11px 18px', display: 'flex', alignItems: 'center', gap: '11px' }}>
        ...
        <span style={{ fontSize: '.84375rem', fontWeight: 700, letterSpacing: '-.2px' }}>SignForge</span>
        <span style={{ marginLeft: 'auto', fontSize: '.6875rem', color: '#64748b', fontFamily: "'Inter', 'Google Sans Flex', sans-serif" }}>Secure signing session · SHA-256 sealed · tamper-evident audit trail</span>
      </header>
