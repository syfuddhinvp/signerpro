  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#eceff4', fontFamily: SF_FONT, color: '#0f172a' }}>
      <header style={{ flex: '0 0 auto', background: '#fff', borderBottom: '1px solid #e3e7ee', padding: '11px 18px', display: 'flex', alignItems: 'center', gap: '11px' }}>
        <span style={{ width: '28px', height: '28px', borderRadius: '9px', background: '#4f46e5', color: '#fff', display: 'grid', placeItems: 'center', fontSize: '11.5px', fontWeight: 700, letterSpacing: '-.5px' }}>SF</span>
        <span style={{ fontSize: '13.5px', fontWeight: 700, letterSpacing: '-.2px' }}>SignForge</span>
        <span style={{ marginLeft: 'auto', fontSize: '11px', color: '#64748b', fontFamily: "'Inter', 'Google Sans Flex', sans-serif" }}>Secure signing session · SHA-256 sealed · tamper-evident audit trail</span>
      </header>
